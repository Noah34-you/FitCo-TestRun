...
/* Catalog prices are a snapshot taken by hand on this date, not a live feed.
   Retailers change prices and run promotions constantly, so the UI must show
   this date next to any price rather than implying it is current. */
export const PRICES_AS_OF = '11 September 2026';
...
export const CATALOG = [
  ...
  { id:'jcrew_770', brand:'J.Crew', name:'770 Straight-Fit Stretch Chino', variant:'', price:90, category:'chinos', primaryFit:'straightFit', secondaryFits:[], img:'/images/products/jcrew_770.jpg', link:'https://www.jcrew.com/p/mens/categories/clothing/pants-and-chinos/chino/770trade-straight-fit-stretch-chino-pant/AR886', benefit:"A straight-fit chino in a middle-of-the-road cut. J.Crew lists it as a core style." },
  { id:'levis_505', brand:"Levi's", name:'505 Regular Straight Jeans', variant:'', price:70, category:'jeans', primaryFit:'straightFit', secondaryFits:[], img:'/images/products/levis_505.jpg', link:'https://www.levi.com/US/en_US/jeans-by-fit-number/men/jeans/505TM/505TM-regular-fit-stretch-mens-jeans/p/005051649', benefit:"Levi's original straight jean, and one of the cheapest ways into a straight leg." },
